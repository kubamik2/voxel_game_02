...
@group(1) @binding(0) var<storage, read> face_buffer: array<vec4u>;
...
@group(5) @binding(0) var light_map_tex: texture_2d<f32>;
@group(5) @binding(1) var light_map_sampler: sampler;
